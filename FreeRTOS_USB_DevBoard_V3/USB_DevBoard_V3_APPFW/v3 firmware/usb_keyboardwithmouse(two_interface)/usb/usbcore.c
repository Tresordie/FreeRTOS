...
uint8_t Keyboard_ReportDescriptor[53] = {
    0x05, 0x01,                    // USAGE_PAGE (Generic Desktop)
    0x09, 0x06,                    // USAGE (Keyboard)
    0xa1, 0x01,                    // COLLECTION (Application)
    0x85, 0x01,
...
uint8_t Mouse_ReportDescriptor[52] = {        
    0x05, 0x01,                    // USAGE_PAGE (Generic Desktop)
                                ...
                                case REPORT_DESCRIPTOR:                             //报告描述符
                                    ...
                                    switch(Device_Request.wIndex)
                                    {
                                        case 0:                 // data request to interface0
                                            pSendData = Keyboard_ReportDescriptor;
                                            SendLength = sizeof(Keyboard_ReportDescriptor);
                                            break;
                                       
                                        case 1:                 // data request to interface1
                                            pSendData = Mouse_ReportDescriptor;
                                            SendLength = sizeof(Mouse_ReportDescriptor); 
