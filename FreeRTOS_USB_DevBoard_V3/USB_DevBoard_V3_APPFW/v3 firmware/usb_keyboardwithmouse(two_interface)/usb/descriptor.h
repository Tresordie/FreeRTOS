...
typedef struct
{
    ...
    Interface_Descriptor_t Interface_Descriptor1;
    HID_Descriptor_t HID_Descriptor1;
    Endpoint_Descriptor_t Endpoint_Descriptor1;                 // Keyboard IN endpoint
    Endpoint_Descriptor_t Endpoint_Descriptor2;                 // Keyboard OUT endpoint(LED control)
    
    Interface_Descriptor_t Interface_Descriptor2;
    HID_Descriptor_t HID_Descriptor2;  
    Endpoint_Descriptor_t Endpoint_Descriptor3;                 // Mouse IN endpoint
}Descriptor_Set_t;
