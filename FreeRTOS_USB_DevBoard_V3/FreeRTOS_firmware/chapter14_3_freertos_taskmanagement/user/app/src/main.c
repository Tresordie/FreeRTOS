...
static TaskHandle_t KEY2_Task_Handle;
static TaskHandle_t KEY4_Task_Handle;
static TaskHandle_t KEY5_Task_Handle;
static TaskHandle_t KEY6_Task_Handle;
static TaskHandle_t KEY7_Task_Handle;
static TaskHandle_t KEY8_Task_Handle;
*/
...
static void KEY1_Task(void* paramter)
{
	while(1)
	{
		if(KeyScan(KEY1_PORT, KEY1_PIN))
		{
            printf("Key1 pressed, LED1_Task suspend!\r\n");
			vTaskSuspend(LED1_Task_Handle);
		}

		if(KeyScan(KEY2_PORT, KEY2_PIN))
		{
			printf("Key2 pressed, LED2_Task resumed!\r\n");
