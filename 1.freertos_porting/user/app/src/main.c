...
static void AppTaskCreate(void)
{
    ...
    xTaskCreate( vTaskLED2Toggle,           // 任务函数
                 "vTaskLED2Toggle",         // 任务名称
                 64,                        // 任务栈大小(字为单位)
                 NULL,                      // 任务函数参数
                 3,                         // 任务优先级(数字越大，优先级越高)
                 &xHandleTaskLED2);         // 任务句柄

    xTaskCreate( vTaskLED3Toggle,           // 任务函数
                 "vTaskLED3Toggle",         // 任务名称
                 64,                        // 任务栈大小(字为单位)
                 NULL,                      // 任务函数参数
                 2,                         // 任务优先级(数字越大，优先级越高)
                 &xHandleTaskLED3);         // 任务句柄

    xTaskCreate( vTaskLED4Toggle,           // 任务函数
                 "vTaskLED4Toggle",         // 任务名称
                 64,                        // 任务栈大小(字为单位)
                 NULL,                      // 任务函数参数
                 1,                         // 任务优先级(数字越大，优先级越高)
